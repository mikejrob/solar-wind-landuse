...
| C5 | New-build line cost | $2.5M/km central; $1.5–4M/km range (138 kV) | `make_expansion_fig_cost.py` (COST_PER_KM_M=2.5), paper §4, Table 5, Fig 5 | MISO Transmission Cost Estimation Guide for MTEP24 (2024$), Table 4.1-1: 138 kV single-circuit **$1.9–2.3M/mile ≈ $1.2–1.4M/km** across MISO states (incl. 30% contingency + 7.5% AFUDC), × Hawaii multiplier (C6); wire only. VERIFIED 2026-07-19: cdn.misoenergy.org/20240501%20PSC%20Item%2004%20MISO%20Transmission%20Cost%20Estimation%20Guide%20for%20MTEP24632680.pdf pp.38–39 | Order-of-magnitude driver of the $-axis; HECO actuals confidential | Yes — Table 5 and Fig 5 caption, wire-only caveat stated |
