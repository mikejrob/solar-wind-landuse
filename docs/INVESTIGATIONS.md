...
| 15–30% slope | Can grid-scale solar use 15–30% land? | 15–20% is buildable at a modeled ~$0.06–0.07/W premium (Ulupono/Fripp SWITCH); 20–30% is a speculative tail with no Hawaii cost basis. Aspect swings yield ±7/−12% at 30% — the band needs an aspect flag. | `notes/slope-15-30-challenges.md` | `data/oahu_poa_aspect_slope.csv` |
