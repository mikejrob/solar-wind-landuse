...
| Steep-slope precedent | Has anyone built solar on 20–30%+ slopes, at what cost? | Yes — Korea/Japan built on 27–47% grade, and it repeatedly landslided. No project pairs a verified >20% slope with a published capex. Tropical volcanic islands (Réunion, Canaries) retreat to flats rather than build steep. Hazard lesson, not cost lesson. | `notes/steep-slope-solar-precedent.md` | — |
