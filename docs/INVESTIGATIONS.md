...
| HECO–military relationship | What agreement governs military electricity? | A 10 USC 2688 utilities-privatization contract: HECO OWNS the on-base distribution at 12 Army installations (50 yr, $638.5M, ownership 2022), billed separately, walled off from the general rate base. Base solar now interconnects to HECO-owned wires — structure documented, intent not; constraints on new on-base generation UNVERIFIED. | `notes/heco-military-relationship.md` | — |
